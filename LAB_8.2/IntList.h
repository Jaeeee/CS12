...
/* Global recursive helper function that passes in the address of a IntNode 
   within an IntList and outputs all of integers within the IntList
   starting from this IntNode.
*/
...
class IntList {
 ...
 public:
   ...
   */
   ...
   /* Outputs to a single line all of the int values stored in the list, 
